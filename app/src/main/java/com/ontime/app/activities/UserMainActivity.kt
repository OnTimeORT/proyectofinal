...
import com.ontime.app.features.addClient.FrAddClientOption
import com.ontime.app.features.addClient.FrAddClientToRow
import com.ontime.app.features.addRow.FrAddRow
import com.ontime.app.features.home.FrHome
import com.ontime.app.features.myClients.FrMyClients
import com.ontime.app.features.myRows.FrMyRows
import com.ontime.app.features.rowsActive.FrRowsActive
...
class UserMainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.nav_account_details) {
            ...
            fragment = FrMyClients()
        } else if (id == R.id.nav_categories) {
            fragment = FrRowsActive()
        } else if (id == R.id.nav_bookings) {
            fragment = FrAddClientToRow()
        } else if (id == R.id.nav_favorites) {
            fragment = FrAddClientOption()
