...
import com.ontime.app.features.accountDetails.FrAccountDetails
import com.ontime.app.features.bookings.FrBookings
import com.ontime.app.features.editAccount.FrEditAccount
import com.ontime.app.features.favorites.FrFavorites
import com.ontime.app.features.homeCategories.FrHomeCategories
import com.ontime.app.features.scanQR.FrScanQR
...
class UserMainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.nav_account_details) {
            fragment = FrAccountDetails()
        } else if (id == R.id.nav_configuration) {
            fragment = FrEditAccount()
        } else if (id == R.id.nav_categories) {
            fragment = FrHomeCategories()
        } else if (id == R.id.nav_bookings) {
            fragment = FrBookings()
        } else if (id == R.id.nav_favorites) {
            fragment = FrFavorites()
