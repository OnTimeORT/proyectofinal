package com.ontime.app.features.auth
...
import com.ontime.app.models.Commerce


class RpAuth(var application: Application) {
    ...
    fun updateProfileCommerce(userId: String, name: String, category: String, phone: String, cuit: String){
        ...
        val commerceData = Commerce(name,category,phone, cuit, null)

        db.collection("commerces").document(userId)
            .set(commerceData)
