...
class FrLogin : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vmLogin = ViewModelProviders.of(this).get(VmLogin::class.java)
        vmLogin.userMutableLiveData.observe(this,
            { firebaseUser: FirebaseUser? ->
                if (firebaseUser != null) {
                    Toast.makeText(activity, "User signed in", Toast.LENGTH_SHORT).show()

                    findNavController().navigate(R.id.action_frLogin_to_userMainActivity)
                }
            }
        )
    }
    ...
    override fun onCreateView(
        ...
        view.btnGoToRegister.setOnClickListener {
            Navigation.findNavController(view)
                .navigate(R.id.action_frLogin_to_frRegister)
        }
                ...
                object : FacebookCallback<LoginResult> {
                    override fun onSuccess(result: LoginResult?) {
                        result?.let {
                            ...
                            vmLogin.loginWithFacebook(token)
                        }
                    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 100) {
            ...
            try {
                ...
                vmLogin.loginWithGoogle(account.idToken!!)
